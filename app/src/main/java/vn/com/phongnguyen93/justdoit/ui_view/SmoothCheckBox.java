...
public class SmoothCheckBox extends View implements Checkable {
  ...
  private void init(AttributeSet attrs) {
    ...
    mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, Utilities.dp2px(getContext(), 0));
    ta.recycle();
  ...
  private int measureSize(int measureSpec) {
    int defSize = Utilities.dp2px(getContext(), DEF_DRAW_SIZE);
